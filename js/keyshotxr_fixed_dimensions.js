...
/*         b += "position:absolute;"; */        
        ...
        v.appendChild(s);
			...
			//var hatt = window.parent.document.getElementById('openfullscreen'); 																															/* create open fullscreen btn */
			//var ap = document.getElementById('openfullscreen'); 																															/* create open fullscreen btn */
			//hatt.onclick=Ja;		
																					
/*         apa = document.createElement("div");	 
		  apa.onclick=Ja;	 
        apa.setAttribute("class", "fullscreen");
        b += "right: 80px;";
        b += "left: auto;";
        b += "background-color: red;";
        b += "position: absolute;";
